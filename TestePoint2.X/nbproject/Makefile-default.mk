...
FINAL_IMAGE=${DISTDIR}/TestePoint2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=TestP2.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/TestP2.o
POSSIBLE_DEPFILES=${OBJECTDIR}/TestP2.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/TestP2.o

# Source Files
SOURCEFILES=TestP2.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/TestePoint2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F887
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/TestePoint2.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/TestP2.o: TestP2.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/TestP2.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/TestP2.o \
	TestP2.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/TestePoint2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    Valores_reginj_PORTB.txt
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F887 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/TestePoint2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
