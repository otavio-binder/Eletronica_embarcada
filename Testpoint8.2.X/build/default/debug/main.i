...
void main(void)
{
    ...
    while(1)
    {
        uint16_t adc_v_temp = ADC_GetConversion(0);
        uint16_t adc_v_lum = ADC_GetConversion(1);
        uint16_t porcent_temp =(uint16_t)((float)adc_v_temp/ 1023.0) * 100.0;
        uint16_t porcent_lum = (uint16_t)((float)adc_v_lum/ 1023.0) * 100.0;
        porcent_temp = (gain * porcent_temp);
        porcent_lum = (gain * porcent_lum);
